...
l1 = tk.Label(my_w,  text='Rule: ', width=10,anchor="c" )  
l1.grid(row=3,column=1) 

# add one text box
t1 = tk.Text(my_w,  height=1, width=50,bg='white') 
...
b1 = tk.Button(my_w,  text='Add Rule', width=10, 
...
def add_data():
     ...
     if(len(my_name) < 5 ) or len(my_class)<2  or len(my_gender) < 2 :
